...
This recipe show you load and display an animated loading page

![Demo](https://github.com/jrasmusson/ios-starter-kit/blob/master/recipes/LoadingPage/images/demo.gif)
